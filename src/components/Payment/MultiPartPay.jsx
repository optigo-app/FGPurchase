          ...
          <div className="w-full">
            ...
            {metalRows?.map((row) => (
              ...
              >
                ...
                <Button variant="contained" size="small" onClick={() => handleMLTEntryRemove(row.id, 'metal')} className='fs_fgp' sx={{background: theme?.palette?.customColors?.red, color: theme?.palette?.customColors?.white, maxWidth:'250px' }}>
                  Remove
                </Button>
              </div>
            ))}
            ...
            {amountRows?.map((row) => (
              ...
              >
                ...
                <Button variant="contained" size="small" onClick={() => handleMLTEntryRemove(row.id, 'amount')} className='fs_fgp' sx={{background: theme?.palette?.customColors?.red, color: theme?.palette?.customColors?.white, maxWidth:'250px' }}>
                  Remove
                </Button>
              </div>
            ))}
            ...
            <div className="d-flex justify-content-between align-items-center mt-3 gap-2 fs_fgp">
              <Button variant="contained" size="small" onClick={() => handleCloseMultiPartPay()} className='fs_fgp' sx={{background: theme?.palette?.customColors?.primary, color: theme?.palette?.customColors?.white, maxWidth:'250px' }}>
                SAVE & Close
              </Button>
              <Button variant="contained" size="small" onClick={addMetalRow} className='fs_fgp' sx={{background: theme?.palette?.customColors?.primary, color: theme?.palette?.customColors?.white, maxWidth:'250px' }}>
                Add Metal Row
              </Button>
              <Button variant="contained" size="small" onClick={addAmountRow} className='fs_fgp' sx={{background: theme?.palette?.customColors?.primary, color: theme?.palette?.customColors?.white, maxWidth:'250px' }}>
                Add Amount Row
              </Button>
            </div>
          </div>
